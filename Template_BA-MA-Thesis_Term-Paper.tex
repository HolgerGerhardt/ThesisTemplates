...
\newcommand{\manuscriptdate}{2026-07-13}  % In ISO format: yyyy-mm-dd
...
\begin{enumerate}[resume, widest* = 10]
	...
	\item What part of the gap is still open? (Phrased a~bit more negatively: What are the limitations of your approach?)
