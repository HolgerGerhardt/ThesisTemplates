...
\newcommand{\manuscripttype}{TP}
	% BA-2F for Bachelor of Arts, 2-Fach-Modell (double-major program)
	% BSc-ECS for Bachelor of Science in Economics and Computer Science
	% BSc-VWL for Bachelor of Science in Volkswirtschaftslehre (Economics)
	% MSc-Econ for Master of Science in Economics
	% otherwise term paper
